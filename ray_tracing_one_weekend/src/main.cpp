...
glm::vec3 ray_colour(const Ray &r, std::vector<Sphere> spheres, RandomState& rnd)
{
    FETriangle tri;
    Vertex v0;
    v0.Position = glm::vec3(0.0, 0.0, -1.0);
    Vertex v1;
    v1.Position = glm::vec3(400.0, 400.0, -1.0);
    Vertex v2;
    v2.Position = glm::vec3(400.0, 0.0, -1.0);
    tri.p0 = v0;
    tri.p1 = v1;
    tri.p2 = v2;
    // hitinfo i;
