...
update_ui_ability_system(entt::registry& r)
{
  ...
  for (const auto& [e, ability_c, colour_c, t_c] :
    ...
    const auto text_size1 = font->CalcTextSizeA(font_size, FLT_MAX, -1, "LB");
    const auto text_size2 = font->CalcTextSizeA(font_size, FLT_MAX, -1, "RB");
    ...
    draw_list->AddText(font, font_size, text_pos1, IM_COL32(255, 255, 255, 255), "LB");
    draw_list->AddText(font, font_size, text_pos2, IM_COL32(255, 255, 255, 255), "RB");
    ImGui::PopFont();
