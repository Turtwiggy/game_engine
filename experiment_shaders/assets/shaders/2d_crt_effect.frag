...
float grille_opacity = 0.5;
vec2 resolution = vec2(640/4, 480/4);
bool pixelate = true; 
bool roll = true;
float roll_speed = 8.0; // Positive values are down, negative are up
float roll_size = 100.0;
...
float distort_intensity = 0.00; // The distortion created by the rolling effect.
...
float static_noise_intensity = 0.04;
...
float warp_amount = 0.5; // Warp the texture edges simulating the curved glass of a CRT monitor or old TV.
bool clip_warp = false;
float vignette_intensity = 0.0; // Size of the vignette, how far towards the middle it should go.
