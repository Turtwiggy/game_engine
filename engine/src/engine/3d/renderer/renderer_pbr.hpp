...
// "assets/textures/pbr_metalgrid/metalgrid2_basecolor.png", "albedo" );
// ResourceManager::load_texture(
// "assets/textures/pbr_metalgrid/metalgrid2_normal-dx.png", "normal" );
// ResourceManager::load_texture(
// "assets/textures/pbr_metalgrid/metalgrid2_metallic.png", "metallic" );
// ResourceManager::load_texture(
// "assets/textures/pbr_metalgrid/metalgrid2_roughness.png", "roughness" );
// ResourceManager::load_texture(
// "assets/textures/pbr_metalgrid/metalgrid2_AO.png", "ao" );
...
//         // on direct lighting.
//         pbr_shader_.set_float("roughness", glm::clamp((float)col /
//         (float)nrColumns, 0.05f, 1.0f));
...
// for (unsigned int i = 0; i < sizeof(light_positions) /
// sizeof(light_positions[0]); ++i)
// {
//     glm::vec3 newPos = light_positions[i] + glm::vec3(sin(time_since_launch
//     * 5.0) * 5.0, 0.0, 0.0); newPos = light_positions[i];
//     pbr_shader_.set_vec3("lightPositions[" + std::to_string(i) + "]",
//     newPos); pbr_shader_.set_vec3("lightColors[" + std::to_string(i) + "]",
//     light_colours[i]);
