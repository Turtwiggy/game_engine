...
void ShadowmappingRenderpass::create_shadowmap_depthbuffer(    
...
glm::mat4 ShadowmappingRenderpass::calculate_light_space_matrix( const glm::vec3& light_pos )
{
...
void ShadowmappingRenderpass::bind( const glm::mat4& light_space_matrix )
{   
...
void ShadowmappingRenderpass::unbind()
{
