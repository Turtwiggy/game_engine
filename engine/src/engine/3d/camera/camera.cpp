...
void FrustumPlane::SetNormalD(glm::vec3 normal, glm::vec3 point)
{
...
glm::mat4 Camera::get_inverse_projection_view_matrix() const
{
...
glm::vec3 Camera::get_eye_ray(float x, float y) const
{
