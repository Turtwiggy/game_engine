...
/*
    Material object, representing all render state required for rendering a
   mesh. This includes shader parameters, texture samplers and GL state relevant
   for rendering a mesh. A material object is required for rendering any scene
   node. The renderer holds a list of common material defaults/templates for
   deriving or creating new materials.
*/
class Material
{
private:
