...
void Material::set_texture(std::string name, Texture2D* value, unsigned int unit)
{
    ...
    {
    case GL_TEXTURE_1D:
        sampler_uniforms_[name].Type      = SHADER_TYPE_SAMPLER1D;
        break;
    case GL_TEXTURE_2D:
        sampler_uniforms_[name].Type      = SHADER_TYPE_SAMPLER2D;
        break;
    case GL_TEXTURE_3D:
        sampler_uniforms_[name].Type      = SHADER_TYPE_SAMPLER3D;
        break;
    case GL_TEXTURE_CUBE_MAP:
        sampler_uniforms_[name].Type        = SHADER_TYPE_SAMPLERCUBE;
        break;
    }
