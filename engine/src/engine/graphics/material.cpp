...
void
Material::set_bool(std::string name, bool value)
{
...
void
Material::set_int(std::string name, int value)
{
...
void
Material::set_float(std::string name, float value)
{
...
void
Material::set_texture(std::string name, Texture2D* value, unsigned int unit)
{
...
void
Material::set_texture_cube(std::string name, TextureCube* value, unsigned int unit)
{
  sampler_uniforms_[name].Unit = unit;
  sampler_uniforms_[name].Type = SHADER_TYPE::SHADER_TYPE_SAMPLERCUBE;
...
void
Material::set_vector(std::string name, glm::vec2 value)
{
...
void
Material::set_vector(std::string name, glm::vec3 value)
{
...
void
Material::set_vector(std::string name, glm::vec4 value)
{
...
void
Material::set_matrix(std::string name, glm::mat2 value)
{
...
void
Material::set_matrix(std::string name, glm::mat3 value)
{
...
void
Material::set_matrix(std::string name, glm::mat4 value)
{
  uniforms_[name].Type = SHADER_TYPE::SHADER_TYPE_MAT4;
  uniforms_[name].Mat4 = value;
}

std::map<std::string, UniformValue>*
Material::get_uniforms()
{
  return &uniforms_;
}

std::map<std::string, UniformValueSampler>*
Material::get_sampler_uniforms()
{
