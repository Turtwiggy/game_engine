...
get_neighbour_gridpos_with_diagonals(const glm::ivec2& xy)
{
  ...
  results.push_back({ GridDirection::north_west,    { xy.x - 1, xy.y + 1 } });
  results.push_back({ GridDirection::north,         { xy.x + 0, xy.y + 1 } });
  results.push_back({ GridDirection::north_east,    { xy.x + 1, xy.y + 1 } });
  results.push_back({ GridDirection::east,          { xy.x + 1, xy.y + 0 } });
  results.push_back({ GridDirection::south_east,    { xy.x + 1, xy.y - 1 } });
  results.push_back({ GridDirection::south,         { xy.x + 0, xy.y - 1 } });
  results.push_back({ GridDirection::south_west,    { xy.x - 1, xy.y - 1 } });
  results.push_back({ GridDirection::west,          { xy.x - 1, xy.y + 0 } });
