...
namespace fightinggame
{
    ...
    void Renderer::init_renderer(int screen_width, int screen_height)
    {
        ...
        //A texture, which will serve as a framebuffer with RGBA32F format

        //A VAO which holds a full-screen-quad to present the framebuffer texture once it's generated by raytracing shader
