...
void fightinggame::RendererRayTraced::init(int screen_width, int screen_height)
{
    printf("init raytraced");
...
void fightinggame::RendererRayTraced::draw_pass(draw_scene_desc& desc, const GameState& state)
{
    int width, height = 0;
