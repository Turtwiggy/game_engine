...
void
generate_broadphase_collisions(const std::vector<std::reference_wrapper<PhysicsObject>>& unsorted_aabb,
                               COLLISION_AXIS axis,
...
//   std::sort(
//     sorted_collidable_x.begin(),
//     sorted_collidable_x.end(),
//     [&](std::reference_wrapper<GameObject2D>& a, std::reference_wrapper<GameObject2D>& b) { return a.get().pos.x <
//     b.get().pos.x; });
//   // SAP x-axis
...
//   std::sort(
//     sorted_collidable_y.begin(),
//     sorted_collidable_y.end(),
//     [&](std::reference_wrapper<GameObject2D>& a, std::reference_wrapper<GameObject2D>& b) { return a.get().pos.y <
//     b.get().pos.y; });
//   // SAP y-axis
