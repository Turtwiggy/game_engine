...
InitSteamDatagramConnectionSockets()
{
  ...
  // Disable authentication when running with Steam, for this example, since we're not a
  // real app.
  // Authentication is disabled automatically in the open-sourceversion since we don't
